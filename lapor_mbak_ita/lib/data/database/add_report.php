...
$query = "INSERT INTO reports (title, description, location, image, latitude, longitude,status) VALUES ('$title', '$description', '$ketLocation', '$image', '$latitude', '$longitude','$status')";
