...
class _LoginState extends State<Login> {
  ...
  late Future<LoginResponseModel> _loginUser;
    ...
    _loginUser.then((value) {
      ...
      if (loginResponseModel.status == "success") {
        Navigator.pushReplacement(context,
          ...
          return Beranda(dataUser: loginResponseModel.user!);
        }));
      } else {
        showDialog(
          context: context,
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text("register"),
              content: Text(loginResponseModel.message),
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    side:
                                        BorderSide(width: 1, color: mutedColor),
                                    shape: RoundedRectangleBorder(
                                        borderRadius:
                                            BorderRadius.circular(28))),
                              ),
