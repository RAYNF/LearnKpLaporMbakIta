...
//kurang latitude,longtitude, verify

class BuatLaporan extends StatefulWidget {
  final User dataUser;

  const BuatLaporan({super.key, required this.dataUser});
...
class _BuatLaporanState extends State<BuatLaporan> {
  ...
  late Future<AddReportModel> _addReport;
  late AddReportModel addReportModel;
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(addReportModel.message),
              actions: <Widget>[
                TextButton(
                  onPressed: () {
